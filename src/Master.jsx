 ...
 return (
  <main className="bg-gray-900 w-full h-screen text-white px-32 p-8 text-xl">
   ...
   <p>
    ...
    messes were privatised, so wastage should have gone down. But with addition of two new hostels, it remains almost the same. The report added the lit's not my problem' attitude of students was
